...
MSBuild SDK for documentation projects (`.docsproj`) - provides a clean way to include documentation in .NET solutions without compilation overhead.
...
| Feature | Manual Setup | CloudNimble.Build.Documentation |
|---------|-------------|--------------------------------|
